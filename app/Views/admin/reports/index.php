...
<div class="container-fluid">
    ...
    <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">User Growth (This Month)</div>
                    <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= number_format($userGrowth['growth_rate'], 2) ?>%</div>
                        </div>
                        <div class="col">
                            <div class="progress progress-sm mr-2">
                                <div class="progress-bar bg-info" role="progressbar" style="width: <?= min($userGrowth['growth_rate'], 100) ?>%" aria-valuenow="<?= $userGrowth['growth_rate'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Site Visits Overview</h6>
        </div>
        <div class="card-body">
            <div class="chart-area">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">User Location Overview</h6>
        </div>
        <div class="card-body">
            <div class="chart-area">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Device Type Overview</h6>
        </div>
        <div class="card-body">
            <div class="chart-area">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Referral Sources Overview</h6>
        </div>
        <div class="card-body">
            <div class="chart-area">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Time Spent on Pages Overview</h6>
        </div>
        <div class="card-body">
            <div class="chart-area">
    ...
    <div class="row">
        <div class="col-lg-6 mb-4">
            <a href="<?= site_url('admin/reports/generate-pdf-report') ?>" class="btn btn-primary btn-icon-split">
...
// Site Visits Chart
var ctx = document.getElementById('siteVisitsChart').getContext('2d');
var siteVisitsChart = new Chart(ctx, {
    type: 'line',
    data: {
        labels: <?= json_encode(array_column($siteVisits, 'visit_date')) ?>,
        datasets: [{
            label: 'Site Visits',
            data: <?= json_encode(array_column($siteVisits, 'visits')) ?>,
            borderColor: 'rgba(78, 115, 223, 1)',
            backgroundColor: 'rgba(78, 115, 223, 0.05)',
            pointRadius: 3,
            pointBackgroundColor: 'rgba(78, 115, 223, 1)',
...
var userLocationChart = new Chart(ctx, {
    type: 'pie',
    data: {
        labels: <?= json_encode(array_column($siteVisits, 'user_location')) ?>,
        datasets: [{
            data: <?= json_encode(array_column($siteVisits, 'visits')) ?>,
            backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc', '#f6c23e', '#e74a3b'],
            hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf', '#f4b619', '#e02d1b'],
...
var deviceTypeChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: <?= json_encode(array_column($siteVisits, 'device_type')) ?>,
        datasets: [{
            label: 'Device Type',
            data: <?= json_encode(array_column($siteVisits, 'visits')) ?>,
...
var ctx = document.getElementById('referralSourcesChart').getContext('2d');
var referralSourcesChart = new Chart(ctx, {
    type: 'doughnut',
    data: {
        labels: <?= json_encode(array_column($siteVisits, 'referral_source')) ?>,
        datasets: [{
            data: <?= json_encode(array_column($siteVisits, 'visits')) ?>,
            backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc', '#f6c23e', '#e74a3b'],
            hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf', '#f4b619', '#e02d1b'],
...
var timeSpentChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: <?= json_encode(array_column($siteVisits, 'time_spent')) ?>,
            borderColor: 'rgba(78, 115, 223, 1)',
            backgroundColor: 'rgba(78, 115, 223, 0.05)',
            pointRadius: 3,
            pointBackgroundColor: 'rgba(78, 115, 223, 1)',
